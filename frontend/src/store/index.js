...
const initialState = {
  ...
  homePageContent: {
    ...
    advantages: {
      ...
      list: [
        {
          en: 'We provide transport according to your needs',
          ua: 'Забезпечуємо транспорт згідно з Вашими потребами'
        },
        {
          en: 'Reasonable and cost-effective pricing',
          ua: 'Аргументована та вигідна вартість'
        },
        {
          en: 'Reliable transportation, we insure liability and cargo',
          ua: 'Надійність перевезення, ми страхуємо відповідальність та вантаж'
        },
        {
          en: 'Regular updates on delivery status',
          ua: 'Регулярне інформування про статус доставки вантажу'
        },
        {
          en: 'Assistance with documentation and permits',
          ua: 'Допомога з документальним супроводом, отриманням дозволів'
        },
        {
          en: 'Working with us, the client optimizes a range of operational costs',
          ua: 'Працюючи з нами, клієнт оптимізує низку операційних витрат'
        }
      ]
    },
    partners: {
